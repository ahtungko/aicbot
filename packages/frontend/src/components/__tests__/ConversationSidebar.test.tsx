...
describe('ConversationSidebar', () => {
  ...
  it('calls onSelectConversation when conversation is clicked', async () => {
    ...
    renderWithQueryClient(
      <ConversationSidebar {...defaultProps} onSelectConversation={mockOnSelect} />
    );
  ...
  it('highlights selected conversation', () => {
    ...
    const selectedConversation = screen.getByText('Test Conversation 1').closest('.bg-blue-50');
  ...
  it('calls onCreateConversation when new conversation button is clicked', async () => {
    ...
    renderWithQueryClient(
      <ConversationSidebar {...defaultProps} onCreateConversation={mockOnCreate} />
    );
  ...
  it('saves edited title when save is clicked', async () => {
    ...
    renderWithQueryClient(
      <ConversationSidebar {...defaultProps} onUpdateConversation={mockOnUpdate} />
    );
